...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff; application=geotiff; profile=cloud-optimized', 'image/jp2', 'application/x-hdf5', 'application/x-hdf', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff', 'image/x.geotiff', 'image/tiff; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true'},
